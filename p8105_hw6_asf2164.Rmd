...
model2_logistic = lm(bwt ~ blength + gaweeks, data = birthweight_df) 

model3_logistic = lm(bwt ~ bhead + blength + babysex + bhead * blength + bhead * babysex + blength * babysex + bhead * blength * babysex, data = birthweight_df)

model1cv_df = 
  crossv_mc(model1plot, 100)
